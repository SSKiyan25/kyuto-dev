<template>
  <ClientOnly>
    <div
      class="relative mb-6 w-full overflow-hidden rounded-lg border border-border/40 bg-gradient-to-r from-primary/90 to-primary/70 shadow-md transition-all hover:shadow-lg"
    >
      <!-- Background pattern for visual interest -->
      <div class="absolute inset-0 opacity-10">
        <div
          class="absolute -right-10 -top-10 h-40 w-40 rounded-full bg-secondary/30 blur-xl"
        ></div>
        <div
      ...
      <div class="relative flex flex-row items-center justify-between p-4 sm:p-6 md:p-8">
        <div class="flex max-w-[75%] flex-col space-y-2 md:max-w-[70%]">
          <h3
            class="text-sm font-bold leading-tight text-primary-foreground sm:text-xl md:text-2xl"
          >
