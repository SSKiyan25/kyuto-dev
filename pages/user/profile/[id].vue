    ...
    >
      <div class="flex flex-row items-center space-x-2">
        ...
        <div class="flex flex-col">
          <span class="text-md font-semibold">John Doe</span>
          <span class="text-sm text-muted-foreground"> BSCS </span>
        </div>
      </div>
